...
function createBase(props) {
  ...
  const minDate = vue.computed(() => props.minDate);
  const maxDate = vue.computed(() => props.maxDate);
  ...
  vue.provide(contextKey$4, context);
  return context;
}
function useOrCreateBase(props) {
  return vue.inject(contextKey$4, () => createBase(props), true);
}
...
function provideSlots(slots, remap = {}) {
  Object.keys(slots).forEach((slotKey) => {
    vue.provide(contextKey$3(remap[slotKey] ?? slotKey), slots[slotKey]);
  });
}
function useSlot(slotKey) {
  return vue.inject(contextKey$3(slotKey), null);
}
const propsDef$1 = {
  ...propsDef$2,
  view: {
...
function createCalendar(props, { slots, emit }) {
  ...
  const navPopoverId = vue.ref(Symbol());
  const dayPopoverId = vue.ref(Symbol());
  ...
  const firstPage = vue.computed(() => head$1(_pages.value) ?? null);
  const lastPage = vue.computed(() => last$1(_pages.value) ?? null);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$c, [
        indicator.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$7, [
          vue.createElementVNode("span", {
            class: vue.normalizeClass(indicator.value.class)
          }, null, 2)
...
const _sfc_main$i = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !!vue.unref(slot) ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(vue.unref(slot)), vue.normalizeProps(vue.mergeProps({ key: 0 }, _ctx.$attrs)), null, 16)) : vue.renderSlot(_ctx.$slots, "default", { key: 1 });
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(Popover, {
        ...
        default: vue.withCtx(({ data: { day, attributes }, hide }) => [
          vue.createVNode(_sfc_main$i, {
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("div", _hoisted_1$b, [
                vue.unref(masks2).dayPopover ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$6, vue.toDisplayString(dayTitle(day)), 1)) : vue.createCommentVNode("", true),
...
function _sfc_render$5(_ctx, _cache) {
  return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$9, _cache[0] || (_cache[0] = [
    vue.createElementVNode("polyline", { points: "15 18 9 12 15 6" }, null, -1)
  ]));
}
...
function _sfc_render$3(_ctx, _cache) {
  return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$7, _cache[0] || (_cache[0] = [
    vue.createElementVNode("path", { d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }, null, -1)
  ]));
}
...
const _sfc_main$c = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(icon.value), {
        width: width.value,
        height: height.value,
        class: "vc-base-icon"
      }, null, 8, ["width", "height"]);
...
const _sfc_main$b = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["vc-header", { "is-lg": _ctx.isLg, "is-xl": _ctx.isXl, "is-2xl": _ctx.is2xl }]),
        style: vue.normalizeStyle(gridStyle.value)
      }, [
        show.value.prev ? (vue.openBlock(), vue.createElementBlock("button", {
          key: 0,
          type: "button",
        ...
        show.value.title ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$5, [
            ...
            default: vue.withCtx(() => [
              vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", _hoisted_3$4, [
                vue.createVNode(_sfc_main$i, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createElementVNode("span", null, vue.toDisplayString(_ctx.page.title), 1)
                  ]),
                  _: 1
                }, 8, ["title"])
              ])), [
                [vue.unref(popoverDirective), navPopoverOptions.value]
              ])
            ]),
            _: 1
          })
        ])) : vue.createCommentVNode("", true),
        show.value.next ? (vue.openBlock(), vue.createElementBlock("button", {
          key: 2,
          type: "button",
...
function usePage() {
  const context = vue.inject(contextKey$1);
  if (context)
    return context;
  throw new Error(
...
const _sfc_main$a = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const prevMonthItems = vue.computed(
    ...
    const prevYearItems = vue.computed(
      () => getYearItems(
    ...
    const nextYearItems = vue.computed(
      () => getYearItems(
        getStartYear(selectedYearGroup.value + 1),
        getEndYear(selectedYearGroup.value + 1)
      )
    ...
    const firstYear = vue.computed(() => head$1(yearItems.value.map((i) => i.year)));
    const lastYear = vue.computed(() => last$1(yearItems.value.map((i) => i.year)));
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", _hoisted_1$5, [
          ...
          }, vue.toDisplayString(title2.value), 33),
          vue.createElementVNode("button", {
            type: "button",
        ...
        vue.createElementVNode("div", _hoisted_4$2, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(activeItems.value, (item) => {
...
const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    createPage(vue.toRef(props, "page"));
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createBlock(Popover, {
        ...
        default: vue.withCtx(({ data: data2 }) => [
          vue.createVNode(_sfc_main$9, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_sfc_main$i, { name: "nav" }, {
                default: vue.withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass([
          "vc-pane",
          `row-${vue.unref(page).row}`,
          `row-from-end-${vue.unref(page).rowFromEnd}`,
          `column-${vue.unref(page).column}`,
          `column-from-end-${vue.unref(page).columnFromEnd}`
        ]),
        ref: "pane"
      }, [
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(page).viewWeeks, (week) => {
            return vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.unref(page).weeknumberPosition ? (vue.openBlock(), vue.createElementBlock("div", {
                key: 0,
                class: vue.normalizeClass(["vc-weeknumber", `is-${vue.unref(page).weeknumberPosition}`])
              }, [
                vue.createElementVNode("span", {
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_CalendarPage = vue.resolveComponent("CalendarPage");
  const _component_CalendarSlot = vue.resolveComponent("CalendarSlot");
  const _component_CalendarPageProvider = vue.resolveComponent("CalendarPageProvider");
  ...
  return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    vue.createElementVNode("div", vue.mergeProps({ "data-helptext": "Press the arrow keys to navigate by day, Home and End to navigate to week ends, PageUp and PageDown to navigate by month, Alt+PageUp and Alt+PageDown to navigate by year" }, _ctx.$attrs, {
      ...
      vue.createElementVNode("div", {
          ...
          default: vue.withCtx(() => [
            (vue.openBlock(), vue.createElementBlock("div", {
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.pages, (page) => {
                return vue.openBlock(), vue.createBlock(_component_CalendarPageProvider, {
                  key: page.id,
                  page
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_CalendarSlot, {
                      ...
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_CalendarPage)
                      ]),
                      _: 2
                    }, 1032, ["page"])
                  ]),
        ...
        vue.createVNode(_component_CalendarSlot, { name: "footer" })
      ], 2)
    ], 16),
    vue.createVNode(_component_CalendarDayPopover),
...
function createDatePicker(props, { emit, slots }) {
  ...
  const datePickerPopoverId = vue.ref(Symbol());
...
const _sfc_main$4 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["vc-base-select", {
        ...
        vue.createElementVNode("select", vue.mergeProps(_ctx.$attrs, {
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.options, (option) => {
            ...
            }, vue.toDisplayString(option.label), 9, _hoisted_2$1);
          }), 128))
        ], 16, _hoisted_1$1),
        _ctx.showIcon ? (vue.openBlock(), vue.createBlock(_sfc_main$c, {
          key: 0,
          name: "ChevronDown",
          size: "18"
        })) : vue.createCommentVNode("", true),
        _ctx.fitContent ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$1, vue.toDisplayString(selectedLabel.value), 1)) : vue.createCommentVNode("", true)
      ], 2);
    };
  }
});
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createVNode(_sfc_main$i, { name: "time-header" }, {
          default: vue.withCtx(() => [
        ...
        vue.createElementVNode("div", _hoisted_6, [
          ...
          vue.unref(timeAccuracy) > 1 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
            _cache[5] || (_cache[5] = vue.createElementVNode("span", { class: "vc-time-colon" }, ":", -1)),
            vue.createVNode(_sfc_main$4, {
          ...
          vue.unref(timeAccuracy) > 2 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
            _cache[6] || (_cache[6] = vue.createElementVNode("span", { class: "vc-time-colon" }, ":", -1)),
            vue.createVNode(_sfc_main$4, {
          ...
          vue.unref(timeAccuracy) > 3 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 2 }, [
            _cache[7] || (_cache[7] = vue.createElementVNode("span", { class: "vc-time-decimal" }, ".", -1)),
            vue.createVNode(_sfc_main$4, {
          ...
          !vue.unref(is24hr) ? (vue.openBlock(), vue.createBlock(_sfc_main$4, {
            key: 3,
...
const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.unref(isTimeMode) ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        class: vue.normalizeClass(`vc-container vc-bordered vc-${vue.unref(color)} vc-${vue.unref(displayMode)}`)
      }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(positions), (position) => {
          return vue.openBlock(), vue.createBlock(_sfc_main$3, {
            key: position,
            position
          }, null, 8, ["position"]);
        }), 128))
      ], 2)) : (vue.openBlock(), vue.createBlock(Calendar, {
        key: 1,
        attributes: vue.unref(attributes),
        ref_key: "calendarRef",
        ref: calendarRef,
        onDayclick: vue.unref(onDayClick),
        onDaymouseenter: vue.unref(onDayMouseEnter),
        onDaykeydown: vue.unref(onDayKeydown)
      }, {
        footer: vue.withCtx(() => [
          vue.unref(isDateTimeMode) ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 0 }, vue.renderList(vue.unref(positions), (position) => {
            return vue.openBlock(), vue.createBlock(_sfc_main$3, {
              key: position,
              position
            }, null, 8, ["position"]);
          }), 128)) : vue.createCommentVNode("", true),
          vue.createVNode(_sfc_main$i, { name: "dp-footer" })
        ]),
        _: 1
...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(Popover, {
        id: vue.unref(datePickerPopoverId),
        placement: "bottom-start",
        class: vue.normalizeClass(`vc-date-picker-content vc-${vue.unref(color)} vc-${vue.unref(displayMode)}`),
        ref_key: "popoverRef",
        ref: popoverRef,
        onBeforeShow: vue.unref(onPopoverBeforeShow),
        onAfterShow: vue.unref(onPopoverAfterShow),
        onBeforeHide: vue.unref(onPopoverBeforeHide),
        onAfterHide: vue.unref(onPopoverAfterHide)
      }, {
        default: vue.withCtx(() => [
          vue.createVNode(_sfc_main$2, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), null, 16)
        ]),
        _: 1
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_DatePickerPopover = vue.resolveComponent("DatePickerPopover");
  const _component_DatePickerBase = vue.resolveComponent("DatePickerBase");
  return _ctx.$slots.default ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
    vue.renderSlot(_ctx.$slots, "default", vue.normalizeProps(vue.guardReactiveProps(_ctx.slotCtx))),
...
exports.PopoverRow = _sfc_main$j;
exports.createCalendar = createCalendar;
exports.createDatePicker = createDatePicker;
exports.default = index;
exports.popoverDirective = popoverDirective;
exports.setupCalendar = setupDefaults;
